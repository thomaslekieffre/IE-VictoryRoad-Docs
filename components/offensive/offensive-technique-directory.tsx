...
import OffensiveTechniqueCard from "./offensive-technique-card";
...
export default function OffensiveTechniqueDirectory({ techniques }: Props) {
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-3xl space-y-4 rounded-2xl border border-white/10 bg-white/95 p-4 shadow-2xl sm:rounded-3xl sm:p-5">
            ...
            <div className="max-h-[75vh] overflow-y-auto">
              <OffensiveTechniqueCard technique={selectedTechnique} isFocused />
            </div>
          </div>
        </div>
      )}
