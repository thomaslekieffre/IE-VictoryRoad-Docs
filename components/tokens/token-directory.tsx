...
export default function TokenDirectory({ tokens }: Props) {
  ...
  return (
    <>
      ...
      >
        <div className="flex justify-center rounded-3xl border border-border/60 bg-card/80 p-4 shadow-xl">
                ...
                <div className="space-y-4">
                  <div className="rounded-2xl border border-border bg-muted/50 overflow-hidden">
                    <img
                      ...
                      loading="lazy"
                    />
                    <p className="px-4 py-2 text-[10px] text-muted-foreground italic text-center">
