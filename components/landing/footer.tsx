...
const Footer = ({ className, ...props }: FooterProps) => {
  return (
    <footer
      className={cn(
        "rounded-3xl border border-border/60 bg-card/80 px-5 py-6 shadow-lg backdrop-blur",
        className,
      )}
      {...props}
    >
      ...
      <div className="mt-6 flex flex-col gap-4 rounded-2xl border border-border px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          {socialLinks.map((link) => {
            ...
            return (
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-border text-muted-foreground transition hover:border-foreground/20 hover:text-foreground"
              >
